...
Namespace Api_ng_sample_code.TO
    Public Class UpdateExecutionReport
        ...
        Public Property InstructionReports() As List(Of UpdateInstructionReport)
            Get
            ...
            End Set
        End Property
        Private m_InstructionReports As List(Of UpdateInstructionReport)

        Public Overrides Function ToString() As String
            Dim sb = New StringBuilder()

            sb.AppendFormat("{0}", "UpdateExecutionReport").AppendFormat(" : CustomerRef={0}", CustomerRef).AppendFormat(" : Status={0}", Status).AppendFormat(" : ErrorCode={0}", ErrorCode).AppendFormat(" : MarketId={0}", MarketId)
